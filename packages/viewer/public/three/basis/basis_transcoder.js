  ...
  return (
    function(moduleArg = {}) {
      ...
      function instantiateArrayBuffer(binaryFile, imports, receiver) {
        return getBinaryPromise(binaryFile).then(binary => WebAssembly.instantiate(binary, imports)).then(
          receiver,
          reason => {
      ...
      function instantiateAsync(binary, binaryFile, imports, callback) {
        if (
          !binary && typeof WebAssembly.instantiateStreaming == "function" && !isDataURI(binaryFile)
          && !isFileURI(binaryFile) && !ENVIRONMENT_IS_NODE && typeof fetch == "function"
        ) {
      ...
      function createJsInvoker(argTypes, isClassMethodFunc, returns, isAsync) {
        ...
        invokerFnBody += (returns || isAsync ? "var rv = " : "") + "invoker(fn" + (argsListWired.length > 0 ? ", " : "")
          + argsListWired + ");\n";
      ...
      function craftInvokerFunction(humanName, argTypes, classType, cppInvokerFunc, cppTargetFunc, isAsync) {
        ...
        if (!needsDestructorStack) {
          for (
            ...
            i < argTypes.length;
            ++i
          ) if (argTypes[i].destructorFunction !== null) closureArgs.push(argTypes[i].destructorFunction);
        }
      ...
      var __embind_register_std_string = (rawType, name) => {
        ...
        registerType(rawType, {
          ...
          toWireType(destructors, value) {
            ...
            if (
              !(valueIsOfTypeString || value instanceof Uint8Array || value instanceof Uint8ClampedArray
